...
export const Button = ({ children, secondary, small, center, full, handleClick }: ButtonProps) => {
  ...
  const btnBig = `${full ? 'w-full' : 'w-32'} px-2 py-4 text-xl`
  const btnSmall = `${full ? 'w-full' : 'w-24'} py-2 text-xs`
